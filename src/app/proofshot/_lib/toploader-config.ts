export const ToploaderConfig = {
  ...
  borders: {
    west: { widthMultiplier: 3, scaleFactor: 1.2, startOpacity: 0.7, endOpacity: 0.4 },
    east: { widthMultiplier: 3, scaleFactor: 1.2, startOpacity: 0.7, endOpacity: 0.4 },
    south: { edgeOpacity: 0.5, centerOpacity: 0.7 },
  },
  overlay: {
    baseOpacity: 0.03,
    innerTint: { red: 240, green: 245, blue: 255, opacity: 0.05 },
    innerEdge: { red: 180, green: 190, blue: 210, opacity: 0.12, lineWidth: 0.8 },
  },
  highlights: {
    top: { heightPercent: 0.3, startOpacity: 0.07, middleOpacity: 0.02, endOpacity: 0 },
  },
  shadows: {
  ...
  shadingLine: { red: 140, green: 140, blue: 140, opacity: 0.45, widthReduction: 0.4 },
  clipping: { topClip: 5 },
