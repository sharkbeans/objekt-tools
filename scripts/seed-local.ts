...
const COSMO_ACCESS_TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0eXBlIjoiYWNjZXNzIiwiaWF0IjoxNzg4NDIwODQwLCJleHAiOjE3ODkwMjU2NDAsInN1YiI6IjU5MzYxIn0.vWoLIeUxwWCEKGb8nFZPm2ZJPQWGoP6acWqRlGla4JQ";
const COSMO_REFRESH_TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0eXBlIjoicmVmcmVzaCIsImlhdCI6MTc4ODQyMDg0MCwiZXhwIjoxNzkzNjA0ODQwLCJzdWIiOiI1OTM2MSJ9.9GYvlYGz7Fb7UmhBDqEhzPFUJbyp3uploCfIzxi9How";
// ============================================================
